...
<img src="assets/hero.svg" width="800" alt="Berat Yurtsever - AI Operating System Boot Screen" />

<br/>

<!-- 02 / IDENTITY MODULE -->
<!-- Core information: Role, Department, and Research Focus -->
<img src="assets/identity.svg" width="800" alt="Berat Yurtsever - Identity Kernel Module" />

<br/>

<!-- 03 / MISSION CONTROL MODULE -->
<!-- Live active projects progress and system health gauge -->
<img src="assets/mission_control.svg" width="800" alt="Berat Yurtsever - Core Mission Control" />

<br/>

<!-- 04 / SYSTEM ARCHITECTURE MODULE -->
<!-- Animated data-flow systems pipeline showing web, API, inference and storage layers -->
<img src="assets/architecture.svg" width="800" alt="Berat Yurtsever - Active Pipeline Architecture" />

<br/>

<!-- 05 / DETAILED REPOSITORY ARTIFACTS -->
<!-- Modular project specification cards detailing game dev, visualizers, and web engines -->
<img src="assets/projects_grid.svg" width="800" alt="Berat Yurtsever - Repository Artifacts" />

<br/>

<!-- 06 / CORE RESEARCH & QUANTIFIER -->
<!-- Domain knowledge matrix and dynamic experimental counters -->
<img src="assets/research_radar.svg" width="800" alt="Berat Yurtsever - Research Metrics Quantifier" />

<br/>

<!-- 07 / TECHNICAL STACK MATRIX -->
<!-- Official flat-design technology shapes (Python, PyTorch, CUDA, etc.) -->
<img src="assets/tech_stack.svg" width="800" alt="Berat Yurtsever - Technical Stack Matrix" />

<br/>

<!-- 08 / SYSTEMS FOOTER -->
<!-- Operating system details and system compile signatures -->
<img src="assets/footer.svg" width="800" alt="Berat Yurtsever - Profile Footer" />
